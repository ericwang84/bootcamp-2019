...
# See lecture notes and DataCamp for guidance and practice
# use double [[]] to reference to list index
...
# Hint: use prop.table()
# The inpuut of prop table is the output of table()
...
#### WRITING FILES ####
write_csv(gapminder07, "data/newdata.csv")
...
hist(gapminder07$lifeExp, xlab="lifeExp", main="histogram")
...
plot(gapminder07$lifeExp~gapminder07$gdpPercap, main="scatterplot", ylab="lifeExp", xlab="gdp per capita")
